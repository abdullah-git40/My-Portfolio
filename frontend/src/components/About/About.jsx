  ...
  return (
    <div className='items-center justify-center flex flex-col mt-9 gap-5  ' id='about'>
      ...
      <p className="text-white text-lg leading-relaxed w-3/4 text-center">
        Hi, I’m <span className="text-violet-400 font-bold">Abdullah</span>, a passionate{" "}
        <span className="text-violet-400">front-end developer</span> who enjoys turning
        ideas into interactive and user-friendly web experiences. With a growing focus
        on <span className="text-violet-400">React</span>, I’ve spent the past few months
